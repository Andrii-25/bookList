...
function AddBook(props) {
    ...
    const notify = () => toast.success(condition ? 'Successfully updated a book!' : 'Successfully added a new book!', {
    ...
    return (
        <div id="main-block">
            ...
            <label>
                ...
                <div style={{fontSize: "12px", color: "red", marginBottom: "10px"}}>{bookError.titleError}</div>
            </label>
            <label>
                Author:
                <input type="text" name="author" value={book.author || ''} onChange={handleChange}/>
                <div style={{fontSize: "12px", color: "red", marginBottom: "10px"}}>{bookError.authorError}</div>
            </label>
            <label>
                Category:
                ...
                <div style={{fontSize: "12px", color: "red", marginBottom: "10px"}}>{bookError.categoryError}</div>
            </label>
            <label>
                ISBN:
                <input type="text" name="ISBN" value={book.ISBN || ''} onChange={handleChange}/>
                <div style={{fontSize: "12px", color: "red", marginBottom: "10px"}}>{bookError.isbnError}</div>
            </label>
            {condition ? <button className="bt bt2" type="submit">Update Book</button> : 
            <button className="bt bt2" type="submit">Add Book</button>}
            </form>
            </div>
        </div>
    )
